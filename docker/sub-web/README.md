...
```shell
docker buildx build --platform linux/amd64,linux/arm64 -t currycan/subweb:25.12.12 -t currycan/subweb:latest --push .

docker run -d -p 58080:80 --restart always --name subweb currycan/subweb:latest
```
