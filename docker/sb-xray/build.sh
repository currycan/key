...
check_version "Sub-Store Front" "$SUB_STORE_FRONTEND_VERSION" "SUB_STORE_FRONTEND_VERSION" "2.16.16"
check_version "Sub-Store Back"  "$SUB_STORE_BACKEND_VERSION"  "SUB_STORE_BACKEND_VERSION"  "2.21.25"
...
check_version "Sing-box"        "$SING_BOX_TAG"               "SING_BOX_VERSION"           "1.12.22"
