...
check_version "Mihomo"          "$MIHOMO_TAG"                 "MIHOMO_VERSION"             "1.19.21"
check_version "Http-Meta"       "$HTTP_META_VERSION"          "HTTP_META_VERSION"          "1.1.0"
check_version "Sub-Store Front" "$SUB_STORE_FRONTEND_VERSION" "SUB_STORE_FRONTEND_VERSION" "2.16.21"
check_version "Sub-Store Back"  "$SUB_STORE_BACKEND_VERSION"  "SUB_STORE_BACKEND_VERSION"  "2.21.51"
check_version "s-ui"            "$SUI_TAG"                    "SUI_VERSION"                "1.4.0"
...
check_version "Sing-box"        "$SING_BOX_TAG"               "SING_BOX_VERSION"           "1.13.3"
